...
function useComposedRefs(...refs) {
  return (void 0)(composeRefs(...refs), refs);
}
...
function PopChild({ children, isPresent: isPresent2, anchorX, root }) {
  ...
  return (void 0)(PopChildMeasure, { isPresent: isPresent2, childRef: ref, sizeRef: size, children: (void 0)(children, { ref: composedRef }) });
}
...
var PresenceChild = ({ children, initial, isPresent: isPresent2, onExitComplete, custom, presenceAffectsLayout, mode, anchorX, root }) => {
  ...
  if (mode === "popLayout") {
    children = (void 0)(PopChild, { isPresent: isPresent2, anchorX, root, children });
  }
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", root }) => {
  ...
  return (void 0)(void 0, { children: renderedChildren.map((child) => {
    ...
    return (void 0)(PresenceChild, { isPresent: isPresent2, initial: !isInitialRender.current || initial ? void 0 : false, custom, presenceAffectsLayout, mode, root, onExitComplete: isPresent2 ? void 0 : onExit, anchorX, children: child }, key);
  }) });
};
...
function createMotionComponent(Component3, { forwardMotionProps = false } = {}, preloadedFeatures, createVisualElement) {
  ...
  function MotionDOMComponent(props, externalRef) {
    ...
    return (void 0)(MotionContext.Provider, { value: context, children: [MeasureLayout2 && context.visualElement ? (void 0)(MeasureLayout2, { visualElement: context.visualElement, ...configAndProps }) : null, useRender(Component3, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, forwardMotionProps)] });
  }
  MotionDOMComponent.displayName = `motion.${typeof Component3 === "string" ? Component3 : `create(${Component3.displayName ?? Component3.name ?? ""})`}`;
  const ForwardRefMotionComponent = (void 0)(MotionDOMComponent);
...
function useScroll({ container, target, ...options } = {}) {
  ...
  const scrollAnimation = (void 0)(null);
  const needsStart = (void 0)(false);
  const start2 = (void 0)(() => {
...
function usePageInView() {
  const [isInView, setIsInView] = (void 0)(true);
  (void 0)(() => {
...
var React4 = __toESM(require_vite_optional_peer_dep_react_framer_motion(), 1);
var id3 = 0;
...
var import_react49 = __toESM(require_vite_optional_peer_dep_react_framer_motion(), 1);
