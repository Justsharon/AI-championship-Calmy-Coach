...
//   return (
//     <div className="min-h-screen pb-24 bg-gradient-to-br from-indigo-50 via-white to-blue-50">
//         <Hero />
...
//       </main>
//       {/* Footer */}
//         <footer className="max-w-6xl mx-auto px-4 mt-12 text-center text-gray-500">Built with LiquidMetal AI Raindrop Platform</footer>
//     </div>
//   );
// }
